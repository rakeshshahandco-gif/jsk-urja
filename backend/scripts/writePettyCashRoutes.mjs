...
const target = path.join(__dirname, '../src/routes/v1/pettyCash.routes.js');
...
router.post('/import/:batchId/approve', pc('approve'), validate(pettyCashValidation.batchId), pettyCashController.approveImport);
...
console.log(buf.includes(0) ? 'FAIL: still UTF-16' : 'OK: UTF-8 written');
