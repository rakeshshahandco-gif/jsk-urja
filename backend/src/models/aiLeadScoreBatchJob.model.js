...
const schema = new mongoose.Schema(
    ...
    { timestamps: true, collection: 'ai_lead_score_batch_jobs' },
);

schema.index({ companyId: 1, status: 1, createdAt: -1 });

const AiLeadScoreBatchJob = mongoose.models.AiLeadScoreBatchJob || mongoose.model('AiLeadScoreBatchJob', schema);
export { AiLeadScoreBatchJob };
export default AiLeadScoreBatchJob;
