...
const stockLedgerSchema = new mongoose.Schema({
    ...
    transactionType: {
        ...
        enum: ['GRN', 'WO_CONSUMPTION', 'WO_OUTPUT', 'COMPONENT_REPLACEMENT', 'PROD_REJECTION',
            ...
            'PROD_FAILURE', 'REWORK_ISSUE', 'REWORK_CONSUMPTION', 'REWORK_QC_PASS', 'REWORK_SCRAP', 'SALES_INVOICE', 'SALES_INVOICE_CANCEL', 'SALES_INVOICE_RESTORE', 'MODEL_CONVERSION', 'TEXTILE_TRANSFORMATION', 'TEXTILE_DYEING_ISSUE', 'TEXTILE_DYEING_RETURN', 'TEXTILE_JOB_WORK_ISSUE', 'TEXTILE_JOB_WORK_RETURN',
