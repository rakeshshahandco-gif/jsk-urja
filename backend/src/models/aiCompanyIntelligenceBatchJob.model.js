...
const schema = new mongoose.Schema(
    ...
    { timestamps: true, collection: 'ai_company_intelligence_batch_jobs' },
);

schema.index({ companyId: 1, status: 1, createdAt: -1 });

const AiCompanyIntelligenceBatchJob = mongoose.models.AiCompanyIntelligenceBatchJob
    || mongoose.model('AiCompanyIntelligenceBatchJob', schema);
export { AiCompanyIntelligenceBatchJob };
export default AiCompanyIntelligenceBatchJob;
