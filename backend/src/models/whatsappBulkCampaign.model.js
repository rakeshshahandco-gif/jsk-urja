...
const whatsappBulkCampaignSchema = new mongoose.Schema(
    {
        ...
        testSendCompletedAt: { type: Date, default: null },
        manualApprovedAt: { type: Date, default: null },
        manualApprovedBy: { type: mongoose.Schema.Types.ObjectId, ref: 'User', default: null },
        aiAssistMeta: { type: mongoose.Schema.Types.Mixed, default: null },
