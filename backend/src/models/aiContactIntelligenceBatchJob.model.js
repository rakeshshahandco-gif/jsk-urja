...
const schema = new mongoose.Schema(
    ...
    { timestamps: true, collection: 'ai_contact_intelligence_batch_jobs' },
);

schema.index({ companyId: 1, status: 1, createdAt: -1 });

const AiContactIntelligenceBatchJob = mongoose.models.AiContactIntelligenceBatchJob
    || mongoose.model('AiContactIntelligenceBatchJob', schema);
export { AiContactIntelligenceBatchJob };
export default AiContactIntelligenceBatchJob;
