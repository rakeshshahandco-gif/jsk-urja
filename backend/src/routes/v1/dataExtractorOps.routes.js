...
router.get('/ops/prospects', checkAnyPermission('data_extractor.company_intelligence.view', 'data_extractor.extractor.view', 'data_extractor.discovery.view'), extractorOpsController.listProspects);
router.post('/ops/prospects/:id/outreach', checkAnyPermission('data_extractor.company_intelligence.view', 'data_extractor.extractor.view'), extractorOpsController.recordOutreach);
router.get('/ops/prospects/:id/outreach-preview', checkAnyPermission('data_extractor.company_intelligence.view', 'data_extractor.extractor.view'), extractorOpsController.outreachPreview);
...
router.post('/ops/history-clear/preview', checkPermission('data_extractor.extractor.settings'), extractorOpsController.historyClearPreview);
router.post('/ops/history-clear', checkPermission('data_extractor.extractor.settings'), extractorOpsController.historyClearExecute);
