...
const listByCustomer = {
    params: Joi.object({
        customerId: objectId.required(),
    }),
    query: Joi.object({
        documentType: Joi.string().valid(...CUSTOMER_DOCUMENT_TYPES).optional(),
    }),
};
...
const customerAndDocumentParams = {
    params: Joi.object({
        customerId: objectId.required(),
        documentId: objectId.required(),
    }),
...
const uploadBody = {
    ...
    body: Joi.object({
        documentType: Joi.string().valid(...CUSTOMER_DOCUMENT_TYPES).required(),
