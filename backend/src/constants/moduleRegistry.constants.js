...
export const MODULE_REGISTRY = [
    ...
    { code: 'whatsapp_ai', label: 'WhatsApp AI', group: MODULE_GROUPS.CORE, menuIds: ['communication-whatsapp-ai-group', 'communication-whatsapp-ai-dashboard', 'communication-whatsapp-ai-inbox', 'communication-whatsapp-ai-active', 'communication-whatsapp-ai-waiting', 'communication-whatsapp-ai-lead-drafts', 'communication-whatsapp-ai-knowledge', 'communication-whatsapp-ai-documents', 'communication-whatsapp-ai-rules', 'communication-whatsapp-ai-settings', 'communication-whatsapp-ai-audit'], apiPrefixes: ['/whatsapp-ai'], permissionModules: ['whatsapp_ai'] },
