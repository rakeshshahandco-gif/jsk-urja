...
export const MODULE_REGISTRY = [
    ...
    { code: 'whatsapp_bulk', label: 'WhatsApp Bulk Messaging', group: MODULE_GROUPS.CORE, menuIds: ['whatsapp-root', 'whatsapp-communication-group', 'communication-bulk-group', 'communication-bulk-campaigns', 'communication-bulk-matter', 'communication-bulk-blacklist', 'communication-bulk-history', 'communication-bulk-number-health', 'communication-bulk-settings'], apiPrefixes: ['/whatsapp-bulk'], permissionModules: ['whatsapp_bulk'] },
    { code: 'whatsapp_ai', label: 'WhatsApp AI', group: MODULE_GROUPS.CORE, menuIds: ['whatsapp-root', 'communication-whatsapp-ai-group', 'communication-whatsapp-ai-dashboard', 'communication-whatsapp-ai-inbox', 'communication-whatsapp-ai-active', 'communication-whatsapp-ai-waiting', 'communication-whatsapp-ai-lead-drafts', 'communication-whatsapp-ai-reply-drafts', 'communication-whatsapp-ai-knowledge', 'communication-whatsapp-ai-documents', 'communication-whatsapp-ai-rules', 'communication-whatsapp-ai-settings', 'communication-whatsapp-ai-audit'], apiPrefixes: ['/whatsapp-ai'], permissionModules: ['whatsapp_ai'] },
    { code: 'whatsapp', label: 'WhatsApp', group: MODULE_GROUPS.CORE, menuIds: ['whatsapp-root', 'whatsapp', 'whatsapp-chat'], apiPrefixes: ['/whatsapp-settings', '/whatsapp-chat', '/whatsapp'], permissionModules: ['whatsapp'] },
