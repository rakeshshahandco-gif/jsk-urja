...
import { SalesInvoice } from '../backend/src/models/salesInvoice.model.js';
import { LedgerEntry } from '../backend/src/models/ledgerEntry.model.js';
...
async function checkLedger() {
    ...
    if (ledgers.length > 0) {
        ...
        entries.forEach(e => {
            console.log(`Date: ${e.date}, Voucher: ${e.voucherNo}, Type: ${e.type}, Amount: ${e.amount}`);
        });
