export const PATHS = {
    ...
    SETTINGS: {
        ...
        WHATSAPP_AI: {
            ROOT: '/communication/whatsapp-ai',
    ...
    PRODUCTION: {
        ...
        OUTPUT_NEW: '/production/output/new',
        CONSUMPTION: '/production/consumption',
        INWARD: '/production/inward',
        QC: '/production/qc',
    ...
    SALES: {
        ...
        CUSTOMER_PRICE_LISTS: '/sales/customer-price-lists',
        CUSTOMER_PRICE_LIST_NEW: '/sales/customer-price-lists/new',
        CUSTOMER_PRICE_LIST_HISTORY: '/sales/customer-price-lists/history',
        CUSTOMER_PRICE_LIST_DETAIL: (id) => `/sales/customer-price-lists/${id}`,
    ...
    DATA_EXTRACTOR: {
        ...
        DISCOVERY_JOB: (id) => `/data-extractor/discovery-jobs/${id}`,
        QUALIFIED_COMPANIES: '/data-extractor/qualified-companies',
        CONSOLIDATED_COMPANIES: '/data-extractor/consolidated-companies',
        CONTACTABLE_PROSPECTS: '/data-extractor/contactable-prospects',
        OPERATIONS: '/data-extractor/operations',
        SAVED_SEARCHES: '/data-extractor/saved-searches',
        DUPLICATE_REVIEW: '/data-extractor/duplicate-review',
