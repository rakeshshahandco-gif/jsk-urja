...
export const MODULE_REGISTRY = [
    ...
    { code: 'whatsapp', label: 'WhatsApp', group: 'core', menuIds: ['whatsapp', 'whatsapp-chat'], permissionModules: ['whatsapp'] },
    { code: 'whatsapp_bulk', label: 'WhatsApp Bulk Messaging', group: 'core', menuIds: ['communication-bulk-campaigns', 'communication-bulk-matter', 'communication-bulk-blacklist', 'communication-bulk-history', 'communication-bulk-settings'], permissionModules: ['whatsapp_bulk'] },
    { code: 'email', label: 'Platform Email', group: 'core', menuIds: ['communication-email-settings', 'communication-history'], permissionModules: ['email'] },
...
const ROUTE_PREFIX_TO_MODULE = [
    ...
    ['/whatsapp', 'whatsapp'], ['/communication/whatsapp-bulk', 'whatsapp_bulk'],
