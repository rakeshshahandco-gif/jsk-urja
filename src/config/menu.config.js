...
export const menuConfig = [
    ...
    },
    {
        ...
        permission: 'admin',
        children: [
            { id: 'companies-list', title: 'Companies', path: PATHS.SETTINGS.COMPANIES_LIST, roles: [ROLES.ADMIN], permission: 'admin.company_profile.view' },
            ...
            { id: 'feature-configuration', title: 'Feature Configuration', path: PATHS.SETTINGS.FEATURE_CONFIGURATION, roles: [ROLES.ADMIN], permission: 'admin' },
            ...
            { id: 'industry-template-master', title: 'Industry Template Master', path: PATHS.SETTINGS.INDUSTRY_TEMPLATES, roles: [ROLES.ADMIN], permission: 'admin' },
            { id: 'company-module-allocation', title: 'Company Module Allocation', path: PATHS.SETTINGS.COMPANY_MODULE_ALLOCATION, roles: [ROLES.ADMIN], permission: 'admin' },
            { id: 'workflow-master', title: 'Workflow Master', path: PATHS.SETTINGS.WORKFLOW_MASTER, roles: [ROLES.ADMIN], permission: 'admin' },
