            ...
            <div className="print-only" style={{ display: 'none', background: '#fff' }}>
                <div style={{ padding: '0px' }}>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', borderBottom: '2px solid #e5e7eb', paddingBottom: '16px', marginBottom: '16px' }}>
                        <div style={{ width: '40%' }}>
                            {company.logoUrl && <img src={company.logoUrl} alt="Logo" style={{ maxHeight: '70px', maxWidth: '200px', objectFit: 'contain' }} />}
                        </div>
                    ...
                    <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '10px', marginBottom: '16px', border: '1px solid #e5e7eb' }}>
                        <thead>
                            <tr style={{ background: '#f9fafb' }}>
                                ...
                                <th style={{ border: '1px solid #e5e7eb', padding: '6px', textAlign: 'left' }}>Description</th>
                                <th style={{ border: '1px solid #e5e7eb', padding: '6px', textAlign: 'center', width: '70px' }}>Quantity</th>
                                <th style={{ border: '1px solid #e5e7eb', padding: '6px', textAlign: 'right', width: '80px' }}>Rate</th>
                                <th style={{ border: '1px solid #e5e7eb', padding: '6px', textAlign: 'right', width: '100px' }}>Amount</th>
                            </tr>
                        </thead>
                        <tbody>
                            {(so.items || []).map((item, i) => (
                                <tr key={i}>
                                    ...
                                    <td style={{ border: '1px solid #e5e7eb', padding: '6px', verticalAlign: 'top' }}>
                                        <div style={{ fontWeight: 'bold', textTransform: 'uppercase' }}>{item.itemName} {item.modelNo ? `(${item.modelNo})` : ''}</div>
                                        {item.itemCode && <div style={{ marginTop: '2px', fontWeight: 'bold', fontSize: '9px', color: '#4b5563' }}>Code: {item.itemCode}</div>}
                                        {item.additionalNotes && <div style={{ marginTop: '6px', fontWeight: 'bold', fontSize: '9px' }}>Additional Notes: {item.additionalNotes}</div>}
                                    </td>
                                    <td style={{ border: '1px solid #e5e7eb', padding: '6px', verticalAlign: 'top' }}>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                            <span style={{ fontSize: '8px' }}>{item.uom}</span>
                        ...
                        <tbody>
                            <tr>
                                <td colSpan="2" style={{ border: '1px solid #e5e7eb', padding: '6px', fontWeight: 'bold' }}>
                            ...
                            {so.freightAmount > 0 && (
                                <tr>
                                    ...
                                    <td style={{ border: '1px solid #e5e7eb', padding: '6px', fontWeight: 'bold', fontSize: '9px' }}>Freight and Forwarding Charges</td>
