...
export default function FinishedGoodsStockReport() {
    ...
    return (
        <div style={{ padding: 24, fontFamily: 'Inter, sans-serif' }}>
            ...
            <div style={{ display: 'flex', gap: 14, marginBottom: 18, flexWrap: 'wrap' }}>
                {[
                    { label: 'Total FG Items', value: summary.totalItems, color: '#8b5cf6' },
                    { label: 'Total Stock Value', value: '₹' + Number(summary.totalValue).toLocaleString('en-IN'), color: '#10b981' },
                    { label: 'Below Reorder', value: summary.belowReorder, color: '#ef4444' },
                ].map(c => (
            ...
            <div style={{ display: 'flex', gap: 10, marginBottom: 16, flexWrap: 'wrap', background: '#f8fafc', padding: '12px 16px', borderRadius: 8, border: '1px solid #e2e8f0' }}>
                ...
                <button onClick={fetchReport} style={{ padding: '6px 16px', background: '#8b5cf6', color: '#fff', border: 'none', borderRadius: 6, cursor: 'pointer', fontSize: 13, fontWeight: 600 }}>Search</button>
